...
const IdentityCardTemplate2 = ({
    ...
    // Background Image
    backgroundImage = '/assets/id-templates/template2-bg.jpeg',
    ...
    return (
        <div className="id-card-wrapper-template2">
            ...
            >
                {/* School Logo */}
                <img src={schoolLogo} className="logo-template2" alt="School Logo" onError={(e: any) => e.target.style.display = 'none'} />
